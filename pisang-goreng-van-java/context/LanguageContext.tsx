...
const translations: Record<Locale, Translations> = {
  id: {
    ...
    hero_desc: 'Pisang goreng premium khas Jawa dengan resep warisan autentik. Renyah tahan lama, dipadukan dengan varian topping melimpah.',
    ...
    about_desc: 'Pisang Goreng Van Java didirikan dengan misi membawa rasa warisan tradisional Jawa ke tingkat premium. Menggunakan bahan-bahan pisang pilihan terbaik yang dipanen langsung oleh petani lokal, berbalut adonan resep rahasia yang menghasilkan kerenyahan tahan lama.',
    about_desc1: 'Pisang Goreng Van Java didirikan dengan misi membawa rasa warisan tradisional Jawa ke tingkat premium. Menggunakan bahan-bahan pisang pilihan terbaik yang dipanen langsung oleh petani lokal.',
    about_desc2: 'Adonan resep rahasia yang menghasilkan kerenyahan tahan lama, dipadukan dengan topping pilihan premium untuk pengalaman kuliner yang tak terlupakan.',
    ...
    footer_tagline: 'Cita rasa pisang goreng premium dengan resep warisan autentik Jawa. Kami bangga mendukung kesejahteraan petani pisang lokal di seluruh pulau Jawa.',
    ...
    location_address_val: 'Jl. Raya Cilangkap RT.02/RW.05, Cilangkap, Kec. Cipayung, Kota Jakarta Timur, DKI Jakarta 13870',
    ...
    faq_a1: 'Tentu! Kami melayani pemesanan partai besar (catering, event) — hubungi kami via WhatsApp untuk info harga spesial.',
    ...
    faq_a3: 'Ya! Kami menyediakan pilihan original (tanpa topping manis) dan bisa request khusus saat pemesanan.',
    faq_q4: 'Apakah ada diskon untuk member?',
    faq_a4: 'Member terdaftar mendapatkan akses promo eksklusif. Daftar sekarang di halaman Login Member!',
    ...
    about_cta_desc: 'Rasakan sendiri cita rasa autentik pisang goreng Van Java — langsung pesan via WhatsApp.',
    about_cta_menu: 'Lihat Menu Lengkap',
    about_cta_find: 'Temukan Kami',
    about_val1_title: 'Bahan Lokal Pilihan',
    about_val1_desc: 'Setiap pisang dipilih langsung dari petani lokal Jawa terpercaya yang menjaga standar kualitas premium.',
    about_val2_title: 'Digoreng Segar',
    about_val2_desc: 'Proses penggorengan dilakukan setiap saat tanpa bahan pengawet, menjaga kerenyahan tahan lama.',
    about_val3_title: 'Higienis & Bersih',
    about_val3_desc: 'Dapur produksi kami memenuhi standar kebersihan tinggi dan selalu diawasi secara berkala.',
    about_val4_title: 'Resep Warisan',
    about_val4_desc: 'Adonan menggunakan resep rahasia turun-temurun yang telah disempurnakan selama bertahun-tahun.',
    about_mile1_event: 'Didirikan dengan satu resep pisang goreng kembung warisan keluarga di dapur rumahan.',
    about_mile2_event: 'Memperluas menu dengan varian Lumpia dan Krispy — langsung jadi favorit pelanggan setia.',
    about_mile3_event: 'Membuka gerai pertama di kawasan Cipayung, Jakarta Timur dengan konsep modern-tradisional.',
    about_mile4_event: 'Meluncurkan layanan pesan antar via WhatsApp dan memperluas jangkauan ke seluruh Jakarta Timur.',
    ...
    login_email_placeholder: 'kamu@email.com',
    ...
    register_subtitle: 'Bergabung dengan komunitas Van Java',
    register_name_label: 'Nama Lengkap',
    register_name_placeholder: 'Nama kamu',
    register_email_label: 'Email',
    register_email_placeholder: 'kamu@email.com',
    ...
    forgot_email_sent_desc: 'Link reset password telah dikirim ke email kamu. Periksa inbox atau folder spam kamu.',
    forgot_title: 'Lupa Password',
    forgot_subtitle: 'Masukkan email untuk menerima link reset',
    forgot_email_label: 'Email',
    forgot_email_placeholder: 'kamu@email.com',
    ...
    forgot_toast_success: 'Link reset dikirim ke email kamu!',
    forgot_toast_error: 'Gagal mengirim, coba lagi',

    // Subpage: Track Order
    track_title: 'Cek Status Pesanan',
    track_desc: 'Masukkan nomor HP yang kamu gunakan saat memesan',
    ...
    review_desc: 'Kepuasan pelanggan adalah bumbu rahasia kami. Berikut adalah ulasan jujur dari mereka yang telah mencicipi kelezatan Pisang Van Java.',
  ...
  en: {
    ...
    hero_desc: 'Premium Javanese fried banana with authentic heritage recipe. Long-lasting crispiness, paired with abundant topping choices.',
    ...
    about_desc: 'Pisang Goreng Van Java was founded with a mission to elevate traditional Javanese heritage flavors to a premium level. Using the finest selection of bananas harvested directly by local farmers, wrapped in a secret recipe batter for long-lasting crispiness.',
    about_desc1: 'Pisang Goreng Van Java was founded with a mission to elevate traditional Javanese heritage flavors to a premium level, using the finest bananas from local farmers.',
    about_desc2: 'Our secret recipe batter delivers long-lasting crispiness, paired with premium toppings for an unforgettable culinary experience.',
    ...
    footer_tagline: 'Premium fried banana flavor with authentic Javanese heritage recipe. We are proud to support local banana farmers throughout Java.',
    ...
    location_address_val: 'Jl. Raya Cilangkap l Rt.2/Rw.5, Cilangkap, Kec. Cipayung, Kota Jakarta Timur 13870',
    ...
    faq_a1: 'Of course! We serve large orders (catering, events) — contact us via WhatsApp for special pricing.',
    faq_q2: 'How long does delivery take?',
    faq_a2: 'Delivery via GoFood & GrabFood usually takes 20-40 minutes depending on distance. For Jakarta Timur area we guarantee product freshness.',
    faq_q3: 'Is there a sugar-free topping option?',
    faq_a3: 'Yes! We provide original options (no sweet toppings) and special requests can be made upon ordering.',
    faq_q4: 'Is there a discount for members?',
    faq_a4: 'Registered members get access to exclusive promos. Register now on the Member Login page!',
    ...
    about_cta_desc: 'Taste the authentic flavor of Van Java\'s fried bananas yourself — order directly via WhatsApp.',
    about_cta_menu: 'See Full Menu',
    about_cta_find: 'Find Us',
    about_val1_title: 'Premium Local Ingredients',
    about_val1_desc: 'Each banana is selected directly from trusted Javanese local farmers who maintain premium quality standards.',
    about_val2_title: 'Freshly Fried',
    about_val2_desc: 'The frying process is done fresh at all times without preservatives, maintaining long-lasting crispiness.',
    about_val3_title: 'Hygiene & Cleanliness',
    about_val3_desc: 'Our production kitchen meets high hygiene standards and is monitored regularly.',
    about_val4_title: 'Heritage Recipe',
    about_val4_desc: 'The batter uses a secret recipe handed down through generations and perfected over the years.',
    about_mile1_event: 'Founded with a single family heritage Javanese fluffy fried banana recipe in a home kitchen.',
    about_mile2_event: 'Expanded the menu with Lumpia and Krispy variants — immediately becoming a favorite among loyal customers.',
    about_mile3_event: 'Opened the first outlet in the Cipayung area, Jakarta Timur with a modern-traditional concept.',
    about_mile4_event: 'Launched delivery service via WhatsApp and expanded coverage across Jakarta Timur.',
    ...
    register_subtitle: 'Join the Van Java community',
    ...
    forgot_email_sent_desc: 'Reset password link has been sent to your email. Please check your inbox or spam folder.',
    ...
    review_desc: 'Customer satisfaction is our secret ingredient. Here are honest reviews from those who have tasted the deliciousness of Van Java.',
